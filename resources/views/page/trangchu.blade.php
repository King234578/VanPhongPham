				...
				<div class="row">
					<div class="col-sm-12">
						<div class="beta-products-list">
							...
							<div class="row" style="text-align: center;">{{$new_product->links("pagination::bootstrap-4")}}</div>
						...
						<div class="beta-products-list">
							...
							<div class="row">
								@foreach($sale_product as $sale)
									<div class="col-sm-3">
										...
										@endif
											<div class="single-item-header">
												<a href="{{route('chitietsanpham', $sale->id)}}"><img src="source/image/product/{{$sale->image}}" alt=""></a>
											</div>
											<div class="single-item-body">
												<p class="single-item-title">{{$sale->name}}</p>
												<p class="single-item-price">
													<!-- @if($sale->promotion_price == $sale->unit_price)
														<span class="flash-sale">{{number_format($sale->unit_price)}} VNĐ</span>
													@else -->
							...
							<div class="row" style="text-align: center;">{{$sale_product->links("pagination::bootstrap-4")}}</div>
						</div> <!-- .beta-products-list -->
					</div>
